...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	4b250513          	addi	a0,a0,1202 # 868 <digits>
 3be:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 47a:	39ac8c93          	addi	s9,s9,922 # 810 <malloc+0x10c>
 ...
 488:	3e4b8b93          	addi	s7,s7,996 # 868 <digits>
 ...
 5ae:	25e98993          	addi	s3,s3,606 # 808 <malloc+0x104>
        while(*s != 0){
 5b2:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 690:	1f47b783          	ld	a5,500(a5) # 880 <freep>
 ...
 6b8:	00e6ea63          	bltu	a3,a4,6cc <free+0x4a>
{
 ...
 6fa:	18f73523          	sd	a5,394(a4) # 880 <freep>
}
 6fe:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72c:	15853503          	ld	a0,344(a0) # 880 <freep>
 ...
 754:	13090913          	addi	s2,s2,304 # 880 <freep>
  if(p == (char*)-1)
 758:	5afd                	li	s5,-1
 75a:	a895                	j	7ce <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 75c:	00000797          	auipc	a5,0x0
 760:	12c78793          	addi	a5,a5,300 # 888 <base>
 764:	00000717          	auipc	a4,0x0
 768:	10f73e23          	sd	a5,284(a4) # 880 <freep>
 76c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 790:	0ea73a23          	sd	a0,244(a4) # 880 <freep>
      return (void*)(p + 1);
