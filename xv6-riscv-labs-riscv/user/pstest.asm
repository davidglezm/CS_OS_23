...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48a:	49a50513          	addi	a0,a0,1178 # 920 <digits>
 48e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54a:	382c8c93          	addi	s9,s9,898 # 8c8 <malloc+0xf4>
 ...
 558:	3ccb8b93          	addi	s7,s7,972 # 920 <digits>
 ...
 67e:	24698993          	addi	s3,s3,582 # 8c0 <malloc+0xec>
        while(*s != 0){
 682:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 760:	1dc7b783          	ld	a5,476(a5) # 938 <freep>
 ...
 788:	00e6ea63          	bltu	a3,a4,79c <free+0x4a>
{
 ...
 7ca:	16f73923          	sd	a5,370(a4) # 938 <freep>
}
 7ce:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7fc:	14053503          	ld	a0,320(a0) # 938 <freep>
 ...
 824:	11890913          	addi	s2,s2,280 # 938 <freep>
  if(p == (char*)-1)
 828:	5afd                	li	s5,-1
 82a:	a895                	j	89e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 82c:	00000797          	auipc	a5,0x0
 830:	11478793          	addi	a5,a5,276 # 940 <base>
 834:	00000717          	auipc	a4,0x0
 838:	10f73223          	sd	a5,260(a4) # 938 <freep>
 83c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 860:	0ca73e23          	sd	a0,220(a4) # 938 <freep>
      return (void*)(p + 1);
